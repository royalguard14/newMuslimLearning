...
<link rel='stylesheet' href='https://vjs.zencdn.net/5-unsafe/video-js.css'><link rel="stylesheet" href="vid_assest/style.css">
...
<div class="container">
 <div class="sidebar">
  ...
  <a class="logo-expand" href="#"><img src="logo.png" alt="YouTube Logo" class="youtube-logo"  /></a>
  <div class="side-wrapper">
   ...
   <div class="side-menu">
    ...
    <a class="sidebar-link streaming" href="#">
     <svg viewBox="0 0 24 24" fill="currentColor">
...
<!-- 2 -->
    <div class="main-blog anim" style="--delay: .2s">
     <div class="main-blog__title">Skateboard Tips You need to knows</div>
...
<!-- end loop -->
   ...
   </div> <!-- end of stream area -->
  </div>
 </div>
</div>
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
<script src='https://vjs.zencdn.net/5-unsafe/video.js'></script><script  src="vid_assest/script.js"></script>
