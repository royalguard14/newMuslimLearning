  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-tools">
        ...
        <div class="btn-group">
          <button type="button" class="btn btn-block btn-light btn-xs" onclick="window.location.href = '{{ route('videoe.create') }}'">Upload Video</button>
        </div>
      </div>
      <!-- tools card -->
    </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#editNow').on('click', function() {
      ...
      var video_path = $('#elink').val();
      $.ajax({
        url: "{{ route('videoe.edit') }}",
        type:"POST",
        data: {id:id,
