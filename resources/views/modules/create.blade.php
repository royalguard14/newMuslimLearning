                        ...
                        <div class="col-sm-12">                            
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {!!Form::text('module','',['class'=>'form-control','placeholder'=>'Enter Name of Module'])!!}                                               
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {!!Form::text('icon','',['class'=>'form-control','placeholder'=>'Enter Icon of Module'])!!}                                               
                                ...
                                <div class="form-group">
                                    ...
                                    {!!Form::textarea('description','',['class'=>'form-control','placeholder'=>'Enter Module Descripiton'])!!}                                               
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            {!!Form::text('routeUri','',['class'=>'form-control','placeholder'=>'Enter Name of Route'])!!}                                               
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                          {!!Form::label('default_url','Default Url')!!}                        
                                            {!!Form::text('default_url','',['class'=>'form-control','placeholder'=>'Enter Default Url'])!!}                                               
